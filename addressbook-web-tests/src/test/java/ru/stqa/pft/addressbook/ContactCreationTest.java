...
public class ContactCreationTest {
  ...
  public void testContactCreation() throws Exception {
    fullname("Ksenya", "Bolshakova", "Valerievna");
    nickname("KsKova");
    ...
    wd.findElement(By.name("address")).sendKeys("Petrova18");
    wd.findElement(By.name("home")).click();
    wd.findElement(By.name("home")).clear();
    wd.findElement(By.name("home")).sendKeys("Home");
    wd.findElement(By.name("mobile")).click();
    wd.findElement(By.name("mobile")).clear();
    wd.findElement(By.name("mobile")).sendKeys("89023298314");
    ...
    wd.findElement(By.name("email")).sendKeys("ks.bol.vr@gmail.com");
    wd.findElement(By.name("email2")).click();
    wd.findElement(By.name("email2")).clear();
    wd.findElement(By.name("email2")).sendKeys("mail2");
    wd.findElement(By.name("email3")).click();
    wd.findElement(By.name("email3")).clear();
    wd.findElement(By.name("email3")).sendKeys("mail3");
    ...
    wd.findElement(By.name("byear")).sendKeys("2003");
  ...
  private void fullname(String firstname, String middlename, String lastname) {
